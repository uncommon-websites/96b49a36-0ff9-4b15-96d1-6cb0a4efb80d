  ...
  <div class="max-w-7xl mx-auto">
    <div class="overflow-hidden relative bg-black text-white p-12 md:p-20 min-h-[600px] flex flex-col justify-between">
      ...
      >
        ...
        <div class="flex-1">
          <h3 class="text-2xl font-medium mb-1">David Herskovic</h3>
          <p class="text-sm text-gray-400 mb-6 uppercase tracking-wider">Head of Asset Management</p>
          <div class="text-sm text-gray-600 mb-8 space-y-1">
            <p>020 7112 5405</p>
            <p>office@woodfell.co.uk</p>
          </div>
          <button class="bg-black text-white px-8 py-4 text-sm font-medium uppercase tracking-wider hover:bg-gray-800 transition-colors">
            Book Consultation
          </button>
        </div>
      </div>
